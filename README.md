...
Para realizar un análisis sobre si una aplicación es una hibridación de medios o un caso de multimedia, tenemos que diferenciar qué es cada una.
...
Partiendo de esta base, ambos ejemplos responden perfectamente a la definición de hibridación.
